        ...
        <div className="min-h-screen relative">
            ...
            <main className="container mx-auto px-4 pt-28 pb-12 md:py-20 max-w-4xl">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h1 className="text-2xl md:text-3xl font-bold">SEBI & MCA Compliance</h1>
                </div>

                <p className="text-sm md:text-base text-muted-foreground mb-10 leading-relaxed">
                    ShareholderVoting.in is architected to facilitate electronic voting in strict adherence to <span className="text-primary font-semibold">SEBI (Listing Obligations and Disclosure Requirements) Regulations, 2015</span> and the <span className="text-primary font-semibold">Companies Act, 2013</span>.
                </p>
